...
class RecallGroupsRecyclerViewAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return if (viewType == 0) {
            val binding:FragmentPieceBinding=DataBindingUtil.inflate(LayoutInflater.from(parent.context),
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is ViewHolder && row is ReadyForReviewTableViewCell )
        {
            ...
            if (Constants.GlobalVariables.hasImages) {
...
//            }else{
    ...
    inner class ViewHolder(val mView: View,val binding:FragmentPieceBinding) : RecyclerView.ViewHolder(mView) {
