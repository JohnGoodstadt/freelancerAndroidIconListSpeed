...
class MusicPieceViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun delete(rg: RecallGroup) = viewModelScope.launch {
        recallGroupRepository.delete(rg)
    }
